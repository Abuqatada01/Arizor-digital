  ...
  return (
    <header className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0a0a0a]" aria-label="L&Q Global Hero Section">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10 flex flex-col items-center text-center">
        ...
        {/* CTA Buttons */}
        <nav aria-label="Hero Call to Actions" className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full max-w-[400px] sm:max-w-none animate-fade-up opacity-0" style={{ animationDelay: '1000ms' }}>
          <a 
            href="#contact" 
            title="Build Your Website with our Web Development Company Mumbai"
            aria-label="Build Your Website - Contact Us"
          ...
          <a 
            href="#work" 
            title="View our Web Development and AI Automation Work"
        ...
        {/* Marquee Section */}
        <section aria-label="Technologies and Partners" className="w-full mt-8 sm:mt-12 animate-fade-up opacity-0" style={{ animationDelay: '1200ms' }}>
          <div className="relative">
            <div className="absolute inset-0 pointer-events-none z-10" aria-hidden="true">
              <div className="absolute left-0 top-0 bottom-0 w-12 sm:w-32 bg-gradient-to-r from-[#0a0a0a] to-transparent" />
              <div className="absolute right-0 top-0 bottom-0 w-12 sm:w-32 bg-gradient-to-l from-[#0a0a0a] to-transparent" />
            </div>
            <Marquee />
          </div>
        </section>
        ...
        <section aria-label="Our Core Benefits" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-5 mt-10 sm:mt-16 w-full max-w-4xl animate-fade-up opacity-0" style={{ animationDelay: '1400ms' }}>
          ...
          {/* Card 1 */}
          <article className="group relative p-5 sm:p-6 lg:p-8 rounded-2xl sm:rounded-3xl border border-white/10 bg-white/[0.04] backdrop-blur-sm transition-all duration-500 hover:bg-white/[0.08] hover:border-white/20 hover:-translate-y-1">
            <div aria-hidden="true" className="absolute inset-0 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            <div className="relative">
          ...
          {/* Card 3 */}
          <article className="group relative p-5 sm:p-6 lg:p-8 rounded-2xl sm:rounded-3xl border border-white/10 bg-white/[0.04] backdrop-blur-sm transition-all duration-500 hover:bg-white/[0.08] hover:border-white/20 hover:-translate-y-1 sm:col-span-2 lg:col-span-1">
            <div aria-hidden="true" className="absolute inset-0 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            <div className="relative">
              <div aria-hidden="true" className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl border border-white/10 bg-white/5 flex items-center justify-center mb-3 sm:mb-5 group-hover:scale-105 transition-transform duration-300">
                <svg focusable="false" aria-hidden="true" className="w-4 h-4 sm:w-5 sm:h-5 text-white/60" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
