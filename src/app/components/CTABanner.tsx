    ...
    <section className="py-[25px]" id="contact">
      <div className="container-custom">
        <div className="bg-[#f4f4f5] rounded-[40px] p-[80px] flex flex-col items-center text-center relative overflow-hidden shadow-floating border border-white/50">
          ...
          <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-[var(--color-primary)] rounded-full blur-[150px] opacity-10 translate-x-1/3 -translate-y-1/3 pointer-events-none"></div>
