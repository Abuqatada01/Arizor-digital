...
export const metadata: Metadata = {
  alternates: {
    canonical: "https://lqglobal.vercel.app/services",
    languages: {
      "en": "https://lqglobal.vercel.app/services",
      "en-IN": "https://lqglobal.vercel.app/services",
      "x-default": "https://lqglobal.vercel.app/services",
    },
  },
};
...
export default function ServicesPage() {
  return (
    <div className="min-h-screen flex flex-col bg-[var(--background)] text-[var(--foreground)] pt-16">
      <h1 className="sr-only">Web Development Services in Mumbai</h1>
      <Navbar />
